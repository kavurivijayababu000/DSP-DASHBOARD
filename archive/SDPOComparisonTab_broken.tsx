...
const SDPOComparisonTab: React.FC<SDPOComparisonTabProps> = ({ 
  ...
  useEffect(() => {
    // Generate SDPO data using the centralized police data service
    const generateSDPOs = (): SDPO[] => {
      ...
      if (comparisonType === 'state-wide' && userRole === 'DGP') {
        ...
        if ((userRole === 'SP' || userRole === 'CP') && userJurisdiction) {
          // Use the new service function to resolve jurisdiction to district
        ...
        // Enhanced debug logging for SP/CP jurisdiction resolution
        console.log('🎯 SP/CP Login Analysis:');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow border">
        <h3 className="text-lg font-semibold mb-4">Top 10 SDPO Performance</h3>
      ...
      <div className="bg-white rounded-lg shadow border overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold">SDPO Performance Details</h3>
        </div>
